...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // Google OAuth redirects away — no need to handle success here
  };
  ...
  return (
    ...
    <div className="min-h-dvh flex flex-col bg-gray-50 dark:bg-slate-950">
      {/* Header gradient */}
      <div
        className="bg-gradient-to-br from-violet-600 to-blue-600 flex flex-col items-center justify-end pb-8 px-6 relative overflow-hidden"
        style={{ minHeight: 'calc(11rem + env(safe-area-inset-top, 0px))', paddingTop: 'env(safe-area-inset-top, 0px)' }}
      >
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-white font-semibold text-lg">CareerPilot AI</span>
          </div>
      ...
      >
        <div className="card p-6">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">
            ...
            <Link href="/auth/signup" className="text-violet-600 dark:text-violet-400 font-medium">
              Sign up
            </Link>
          </p>
